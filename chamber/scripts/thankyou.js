window.addEventListener("load", () => {
    ...
    const timeform = params.get("current-time");
    ...
    document.getElementById("membership-form").innerHTML = membership;
    document.getElementById("date-form").innerHTML = dateform;
    document.getElementById("time-form").innerHTML = timeform;
  });
