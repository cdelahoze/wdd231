    ...
    textsCatalog = [
      {
        ...
        content:
          "Learning software development requires consistent daily practice. When you highlight any word in this text, the dictionary will display its meaning, audio pronunciation, and interactive synonyms.",
...
function populateSelectMenu(catalog) {
  ...
  savedTextsSelect.innerHTML =
    '<option value="">-- Selecciona un texto del catálogo --</option>';
...
if (savedTextsSelect) {
  savedTextsSelect.addEventListener("change", (e) => {
    ...
    if (selectedItem) {
      ...
      textContentDisplay.innerHTML = selectedItem.content;
    }
  });
}
